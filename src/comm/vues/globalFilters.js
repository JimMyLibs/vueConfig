import Vue from 'vue'
import dateFormat from 'comm/js/datetime/dateFns'
import { sixFixed, toDecimal, splitStr, splitNum } from 'comm/js/num/numberFns'

export default (projectFilters = {}) => {

    Object.keys(projectFilters).forEach(item => {
        Vue.filter(item, projectFilters[item])
    })
